...
object CommandInput {
  ...
  *
  ...
  final case class FindGroups(radius: Option[Int], category: Option[Category], location: Option[Location], keyword: Option[String])

  final case class FindEvents(radius: Option[Int], category: Option[Category], location: Option[Location], keyword: Option[String])
